...
const PRODUCTS = [
  ...
  { value: "nexus", label: "BlackSentinel Nexus - SIEM" },
  { value: "sentinel", label: "BlackSentinel Sentinel - Digital Sovereignty" },
  { value: "strike", label: "BlackSentinel Strike - Offensive Security" },
  { value: "pulse", label: "BlackSentinel Pulse - Attack Surface Management" },
  { value: "guardian", label: "BlackSentinel Guardian - Endpoint Protection" },
  { value: "vault", label: "BlackSentinel Vault - Secrets & Privileged Access" },
  { value: "vision", label: "BlackSentinel Vision - Threat Intelligence" },
  { value: "forge", label: "BlackSentinel Forge - Security Automation" },
  { value: "command", label: "BlackSentinel Command - Management Console" },
  { value: "ai", label: "BlackSentinel AI - AI Security Engine" },
